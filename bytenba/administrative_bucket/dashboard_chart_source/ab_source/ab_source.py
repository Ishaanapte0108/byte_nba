...
def get(**kwargs):  
	...
	document_types = ['Administrative Co-Curricular Activities', 'Administrative Co-Curricular Activities 2', 'Departmental Roles', 'Institute Binding Activities', 'Institute Level Academic Activities Organized', 'Institutional Committee Activities', 'Institutional Governance Responsibilities', 'Membership of Professional Associations', 'Organization of activities']
