...
Doctype = 'Grades in preceding semester preview'
pattern_for_wtg = r'\((\s*(?:\d+\.\d+|\d+)\s*)\)'

class Gradesinprecedingsemesterpreview(Document):

	"""method to autoname your document"""
	def autoname(self):
		self.name = f'AI13_{self.owner}_{self.academic_year}_{self.semester}'
